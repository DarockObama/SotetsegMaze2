...
function showAbout() {
	alert("Practice tool for running a fast maze at solo TOB.");
}

function showInstructions() {
	alert(
        "1. Click 'new blind maze' to start.\n" +
        "2. The maze with path appears, after 10 seconds the path will disappear.\n" +
...
function hideMaze(x, y, color_tile) {
